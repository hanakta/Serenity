-- 🔄 Ультра-простое обновление существующей базы данных serenity
...
-- 6. Добавляем демо комментарии к задачам (только если их нет)
...
-- 7. Добавляем демо логи активности (только если их нет)
